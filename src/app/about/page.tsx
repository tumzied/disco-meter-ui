        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-1.5 font-semibold text-gray-900">
              <span className="text-blue-600 text-lg">⚡</span> DESCO Dashboard
            </Link>
        ...
        <section className="bg-white border-y border-gray-100">
          <div className="max-w-3xl mx-auto px-4 py-16">
            ...
            <div className="space-y-4">
              {steps.map((s) => (
                <div key={s.n} className="bg-gray-50 border border-gray-200 rounded-2xl p-5 flex gap-4">
        ...
        <section className="max-w-3xl mx-auto px-4 pb-16">
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 text-sm text-amber-800">
            ...
            <p className="leading-relaxed">
              This is an unofficial personal dashboard. It reads publicly accessible data from the
              DESCO prepaid API on your behalf. It is not affiliated with or endorsed by DESCO.
              For official support, contact DESCO directly on{" "}
              <a href="tel:16120" className="font-medium underline">16120</a>.
            </p>
          </div>
        </section>
      </main>
